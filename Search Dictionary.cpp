...
#include <fstream>
#include<string>  // library that contains file input/output functions
using namespace std;
...
{      char meaning[1000];
  ...
  int array_size = 99999999; // define the size of character array
  ...
  for(int i = 0; word[i] != '\0'; i++)
  {
	...
	ifstream fin("Oxford.txt"); //opening an input stream for file test.txt
