...
class CK_VISIBLE_PUBLIC CkFtp2W  : public CkWideCharBase
{
	...
	// included in the following properties and methods: GetDirCount, NumFilesAndDirs,
	...
	CkTaskW *AppendFileAsync(const wchar_t *localFilename, const wchar_t *remoteFilename);
	...
	// v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *AppendFileFromBinaryDataAsync(const wchar_t *remoteFilename, const CkByteData &content);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *ChangeRemoteDirAsync(const wchar_t *relativeDirPath);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *CreateRemoteDirAsync(const wchar_t *dir);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *DeleteRemoteFileAsync(const wchar_t *filename);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *GetFileAsync(const wchar_t *remoteFilename, const wchar_t *localFilename);
	...
	// Creates an asynchronous task to call the GetLastAccessDt method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *GetLastAccessDtAsync(int index);
	...
	// Creates an asynchronous task to call the GetLastAccessDtByName method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *GetLastAccessDtByNameAsync(const wchar_t *filename);
	...
	// Creates an asynchronous task to call the GetLastAccessTimeByNameStr method with
	// the arguments provided. (Async methods are available starting in Chilkat
	// v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *GetLastAccessTimeByNameStrAsync(const wchar_t *filename);
	...
	// Creates an asynchronous task to call the GetLastAccessTimeStr method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *GetLastAccessTimeStrAsync(int index);
	...
	// with the arguments provided. (Async methods are available starting in Chilkat
	// v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *NlstXmlAsync(const wchar_t *pattern);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *PutFileAsync(const wchar_t *localFilename, const wchar_t *remoteFilename);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *PutFileFromBinaryDataAsync(const wchar_t *remoteFilename, const CkByteData &content);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *RemoveRemoteDirAsync(const wchar_t *dir);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *RenameRemoteFileAsync(const wchar_t *existingFilename, const wchar_t *newFilename);
	...
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *SyncRemoteTree2Async(const wchar_t *localRoot, int mode, bool bDescend, bool bPreviewOnly);
